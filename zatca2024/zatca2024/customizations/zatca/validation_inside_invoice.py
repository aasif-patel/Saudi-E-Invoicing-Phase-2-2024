...
from zatca2024.zatca2024.customizations.zatca.zatcasdkcode import sign_invoice,generate_qr_code,generate_hash,clearance_API,_execute_in_shell,get_API_url,xml_base64_Decode,validate_invoice
                ...
                try:
                    ...
                    try:
                        ...
                        if response.status_code != 200:
                            frappe.throw(_("Error: {0}").format(str(response.text)))    
                    
                    except Exception as e:
                        frappe.msgprint(str(e))
                        return "error", "NOT ACCEPTED"
                except Exception as e:
                    frappe.throw(_("ERROR in clearance invoice ,zatca validation: {0}"),format(str(e)))